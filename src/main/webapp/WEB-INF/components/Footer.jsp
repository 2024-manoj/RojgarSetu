  ...
  <div class="footer-container">
    ...
    <div class="footer-brand">
      ...
      <p class="footer-tagline">
        &#169; 2024 RojgarSetu. Connecting Koshi Province to modern
        opportunities.
      </p>
    </div>
      ...
      <ul class="footer-links">
        <li>
          <a href="${pageContext.request.contextPath}/jobs"
            ><i class="fas fa-chevron-right"></i> Jobs</a
          >
        </li>
        <li>
          <a href="${pageContext.request.contextPath}/candidates"
            ><i class="fas fa-chevron-right"></i> Candidates</a
          >
        </li>
        <li>
          <a href="${pageContext.request.contextPath}/post-job"
            ><i class="fas fa-chevron-right"></i> Post a Job</a
          >
        </li>
      </ul>
    </div>
    ...
    <div class="footer-col">
      ...
      <ul class="footer-links">
        ...
        <li>
          <a href="#"><i class="fas fa-chevron-right"></i> Employer Guide</a>
        </li>
      </ul>
    </div>
    ...
    <div class="footer-col">
      ...
      <ul class="footer-links contact-list">
        <li>
          ...
          <a href="https://github.com/2024-manoj">katwalmanoj67@gmal.com</a>
        </li>
        <li>
