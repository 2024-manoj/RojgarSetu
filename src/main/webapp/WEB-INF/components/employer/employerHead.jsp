<%--
  Employer shared <head> — common meta, fonts, icons, stylesheets.
  Include inside <head> tag of every employer page.
...
<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/static/employer.css"/>
