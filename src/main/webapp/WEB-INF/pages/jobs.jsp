...
<section class="jobs-section">
    <div class="jobs-container">
        ...
        <div class="jobs-header">
            ...
            <p class="jobs-subtitle">Browse through thousands of job opportunities across Koshi Province</p>
        </div>
        ...
        <div class="search-bar">
            <div class="search-input-wrapper">
                ...
                <input type="text" class="search-input" placeholder="Search by keyword..." id="searchKeyword">
            </div>
        ...
        <div class="jobs-layout">
            ...
            <main class="job-listings">
                ...
                <div class="jobs-grid" id="jobsGrid">
                    <!-- Job Card 1 -->
                    <div class="job-card" data-category="IT" data-location="Kathmandu" data-salary="2000">
                        <div class="job-card-header">
                            <h3 class="job-title">Software Engineer</h3>
                            <span class="job-category">IT</span>
                        </div>
                        <p class="job-company">
                            <i class="fas fa-building"></i> Tech Solutions Inc. - Kathmandu
                        </p>
                        <p class="job-salary">
                            <i class="fas fa-dollar-sign"></i> $1,500 - $2,500
                        </p>
                        <button class="apply-btn" onclick="applyJob('Software Engineer', 'Tech Solutions Inc.')">
                            <i class="fas fa-paper-plane"></i> Apply
                        </button>
                    </div>

                    <!-- Job Card 2 -->
                    <div class="job-card" data-category="Marketing" data-location="Pokhara" data-salary="1400">
                        <div class="job-card-header">
                        ...
                        <button class="apply-btn" onclick="applyJob('Marketing Specialist', 'Global Marketing Co.')">
                            <i class="fas fa-paper-plane"></i> Apply
                        </button>
                    </div>

                    <!-- Job Card 3 -->
                    <div class="job-card" data-category="Finance" data-location="Biratnagar" data-salary="1700">
                        <div class="job-card-header">
                            <h3 class="job-title">Financial Analyst</h3>
                            <span class="job-category">Finance</span>
                        </div>
                        <p class="job-company">
                            <i class="fas fa-building"></i> Wealth Management Ltd. - Biratnagar
                        </p>
                        <p class="job-salary">
                            <i class="fas fa-dollar-sign"></i> $1,200 - $2,200
                        </p>
                        <button class="apply-btn" onclick="applyJob('Financial Analyst', 'Wealth Management Ltd.')">
                            <i class="fas fa-paper-plane"></i> Apply
                        </button>
                    </div>

                    <!-- Job Card 4 -->
                    <div class="job-card" data-category="IT" data-location="Kathmandu" data-salary="2500">
                        <div class="job-card-header">
                            <h3 class="job-title">Data Scientist</h3>
                            <span class="job-category">IT</span>
                        </div>
                        <p class="job-company">
                            <i class="fas fa-building"></i> Data Insights Corp. - Kathmandu
                        </p>
                        <p class="job-salary">
                            <i class="fas fa-dollar-sign"></i> $2,000 - $3,000
                        </p>
                        <button class="apply-btn" onclick="applyJob('Data Scientist', 'Data Insights Corp.')">
                            <i class="fas fa-paper-plane"></i> Apply
                        </button>
                    </div>

                    <!-- Job Card 5 -->
                    <div class="job-card" data-category="HR" data-location="Pokhara" data-salary="1650">
                        <div class="job-card-header">
                            <h3 class="job-title">HR Manager</h3>
                            <span class="job-category">HR</span>
                        </div>
                        <p class="job-company">
                            <i class="fas fa-building"></i> People Solutions Inc. - Pokhara
                        </p>
                        <p class="job-salary">
                            <i class="fas fa-dollar-sign"></i> $1,300 - $2,000
                        </p>
                        <button class="apply-btn" onclick="applyJob('HR Manager', 'People Solutions Inc.')">
                            <i class="fas fa-paper-plane"></i> Apply
                        </button>
                    </div>

                    <!-- Job Card 6 -->
                    <div class="job-card" data-category="Sales" data-location="Biratnagar" data-salary="1150">
                        <div class="job-card-header">
                        ...
                        <button class="apply-btn" onclick="applyJob('Sales Executive', 'Sales Force Ltd.')">
                            <i class="fas fa-paper-plane"></i> Apply
                        </button>
                    </div>
                </div>
        ...
        <div class="modal-body">
            ...
            <form id="applicationForm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" id="applicantName" placeholder="Enter your full name" required>
                </div>
                <div class="form-group">
                    <label><i class="fas fa-envelope"></i> Email</label>
                    <input type="email" class="form-input" id="applicantEmail" placeholder="Enter your email" required>
                </div>
                <div class="form-group">
                    <label><i class="fas fa-link"></i> Resume/CV Link</label>
                    <input type="text" class="form-input" id="resumeLink" placeholder="Google Drive / LinkedIn link">
                </div>
                <div class="form-group">
                    <label><i class="fas fa-comment"></i> Tell us why you're a good fit...</label>
                    <textarea class="form-textarea" id="coverLetter" rows="4" placeholder="Cover Letter"></textarea>
                </div>
...
<script>
    ...
    function filterJobs() {
        ...
        const selectedCategories = Array.from(document.querySelectorAll('.filter-checkbox input[type="checkbox"]:checked')).map(cb => cb.value);
        const selectedLocations = Array.from(document.querySelectorAll('.filter-group:nth-child(2) .filter-checkbox input:checked')).map(cb => cb.value);
        ...
        jobCards.forEach(card => {
            ...
            let matchesLocation = selectedLocations.length === 0 || selectedLocations.includes(location);
            let matchesSalary = true;

            if (selectedSalary === 'below') matchesSalary = salary < 1000;
            else if (selectedSalary === 'mid') matchesSalary = salary >= 1000 && salary <= 2000;
            else if (selectedSalary === 'above') matchesSalary = salary > 2000;

            if (matchesKeyword && matchesCategory && matchesLocation && matchesSalary) {
    ...
    function updateFilteredJobs() {
        filteredJobs = Array.from(jobCards).filter(card => card.style.display !== 'none');
        updateJobCount();
    ...
    function resetFilters() {
        ...
        document.querySelectorAll('.filter-radio input').forEach(radio => radio.checked = false);
        searchInput.value = '';
        filterJobs();
    }
